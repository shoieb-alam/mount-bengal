                    ...
                    <Row xs={1} md={2} lg={3} className="g-3">
                        ...
                        <Col>
                            ...
                            <div className="mt-4">
                                ...
                                <Link as={HashLink} className="text-decoration-none text-white" to="/home#service">Service</Link> <br />
                                <Link className="text-decoration-none text-white" to="/doctors">Doctors</Link> <br />
                            </div>
                        </Col>
                        ...
                        <Col>
                            ...
                            <div className="mt-4">
                                ...
                                <p>
                                    <FontAwesomeIcon icon={faEnvelopeOpen} className="me-2" /> support.mb@gmail.com
                                </p>
                                <p>
                                    <FontAwesomeIcon icon={faHospital} className="me-2" /> Uttara, Dhaka-1230 Bangladesh
                                </p>
                            </div>
                        </Col>
